...
4. **State Subsystem** — a `PROGRESS.md` tracking completed work, in-progress items, blockers; updated before a session ends, reviewed when the next begins. See [[Agent State Management]].
